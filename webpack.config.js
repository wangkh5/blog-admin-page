...
module.exports = {
  ...
  output: { // 指定输出选项
    ...
    filename: 'admin_bundle.js' // 指定输出文件的名称
  },
  plugins: [ // 所有webpack  插件的配置节点
    new htmlWebpackPlugin({
      template: path.join(__dirname, './src/admin.html'), // 指定模板文件路径
      filename: 'admin.html', // 设置生成的内存页面的名称
      favicon: './qbs_favicon.ico'
    }),
    new ExtractTextPlugin('admin_bundle.css'),
  ],
